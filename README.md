...
- Output file `onsite_processed_data_output.csv`
   ...
   For onsite data analysis, a new processed data file is generated by merging the information of onsite interval gained from `2021VAERSDATA.csv` into the dataframe of `final_processed_data_output.csv` using innerjoin on VAERS_IDs. This processed data output file called `onsite_processed_data_output.csv` is used as the main input file for analysis later.
